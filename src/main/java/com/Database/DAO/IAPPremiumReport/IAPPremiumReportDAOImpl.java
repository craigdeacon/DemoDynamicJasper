        ...
        jdbcTemplate.query(IAP_DSAI_PREMIUM_QRY,
                           rs ->
                           {
                               iapDSAIGroupList.add(new IAPPremiumDSAIGroup(rs.getString("division_name"),
                                                                            ...
                                                                            rs.getDouble("current_prem"),
                                                                            rs.getDouble("retro_prem"),
                                                                            rs.getDouble("pst")));
                           });
        ...
        jdbcTemplate.query(IAP_ADD_PREMIUM_QRY,
                           rs ->
                           {
                               iapADDGroupList.add(new IAPPremiumADDGroup(rs.getString("pol_no"),
                                                                                  ...
                                                                                  rs.getDouble("current_volume_of_ins"),
                                                                                  rs.getDouble("grossrate"),
                                                                                  null,
                                                                                  null,
                                                                                  null,
                                                                                  null,
                                                                                  ...
                                                                                  rs.getDouble("adjust"),
                                                                                  rs.getDouble("admin_fee"),
                                                                                  rs.getDouble("commission"),
                                                                                  rs.getDouble("totalcommission"),
                                                                                  rs.getDouble("on_tax"),
                                                                                  rs.getDouble("qc_tax"),
                                                                                  rs.getDouble("mb_tax"),
                                                                                  rs.getDouble("net_prem_paid"),
        ...
        jdbcTemplate.query(IAP_OPTIONAL_ADD_PREMIUM_QRY,
                           rs ->
                           {
                               iapOptionalADDGroupList.add(new IAPPremiumOptionalADDGroup(rs.getString("pol_no"),
                                                                                          ...
                                                                                          rs.getString("empprovsplit"),
                                                                                          rs.getInt("current_no_of_lives"),
                                                                                          rs.getDouble("currentsinglevolume"),
                                                                                          rs.getDouble("currentfamilyvolume"),
                                                                                          rs.getDouble("currentsinglerate"),
                                                                                          rs.getDouble("currentfamilyrate"),
                                                                                          rs.getDouble("total_gross_prem"),
                                                                                          rs.getDouble("adjust"),
                                                                                          rs.getDouble("admin_fee"),
                                                                                          rs.getDouble("commission"),
                                                                                          rs.getDouble("on_tax"),
        ...
        jdbcTemplate.query(IAP_PREMIUM_QRY,
                           rs ->
                           {
                               iapGroupList.add(new IAPPremiumGroup(rs.getString("pol_no"),
                                                                    ...
                                                                    rs.getDouble("spouse_volume"),
                                                                    rs.getDouble("spousetotalpremium"),
                                                                    rs.getString("spouserate"),
                                                                    rs.getString("dependentbenefitamount"),
                                                                    rs.getInt("dependent_unit"),
                                                                    rs.getDouble("dependentrate"),
                                                                    rs.getDouble("dependenttotalpremium"),
                                                                    rs.getDouble("gross_prem"),
                                                                    rs.getDouble("adjust"),
                                                                    rs.getDouble("admin_fee"),
                                                                    rs.getDouble("commission"),
