 ...
 */
package com.Report.Component.TestReportComponent.secondReport.entity;
...
import com.Report.Component.TestReportComponent.secondReport.repository.EmployeeReportRepository;
...
public class EmployeeReport
{
    ...
    public void displayEmployeeReport()
    {
        ...
        try
        {
            ...
            //Dynamic Report Builder, sets parameters, margins, page size, etc.
...
//            dynamicReportBuilder.setTemplateFile("C:/Users/craig.deacon/Documents/NetBeansProjects/jasperreport/Templates/online_template.jrxml", true, true, true, false);
            dynamicReportBuilder.addFirstPageImageBanner( logoPath, logoWidth, logoHeight, ImageBanner.Alignment.Left );
